  ...
  ocean: {
    ...
    syntax: {
      light: convertToShikiTheme({
        ...
        parameter: "#0891b2",
        function: "#0ea5e9",
        stringExpression: "#14b8a6",
        punctuation: "#0f172a",
        link: "#0ea5e9",
        number: "#22c55e",
        property: "#38bdf8",
        highlight: "rgba(14,165,233,0.10)",
        highlightHover: "rgba(14,165,233,0.06)",
      ...
      dark: convertToShikiTheme({
        ...
        parameter: "#67e8f9",
        function: "#7dd3fc",
        stringExpression: "#5eead4",
        punctuation: "#e2e8f0",
        link: "#7dd3fc",
        number: "#86efac",
        property: "#7dd3fc",
        highlight: "rgba(125,211,252,0.14)",
        highlightHover: "rgba(125,211,252,0.08)",
  ...
  lavender: {
    ...
    syntax: {
      light: convertToShikiTheme({
        ...
        parameter: "#7c3aed",
        function: "#a78bfa",
        stringExpression: "#d946ef",
        punctuation: "#1f2937",
        link: "#7c3aed",
        number: "#f59e0b",
        property: "#7c3aed",
        highlight: "rgba(167,139,250,0.12)",
        highlightHover: "rgba(167,139,250,0.07)",
      ...
      dark: convertToShikiTheme({
        ...
        parameter: "#c4b5fd",
        function: "#e9d5ff",
        stringExpression: "#f0abfc",
        punctuation: "#f3f4f6",
        link: "#c4b5fd",
        number: "#fde68a",
        property: "#c4b5fd",
        highlight: "rgba(196,181,253,0.16)",
        highlightHover: "rgba(196,181,253,0.10)",
  ...
  carbon: {
    ...
    syntax: {
      light: convertToShikiTheme({
        ...
        parameter: "#f59e0b",
        function: "#e11d48",
        stringExpression: "#10b981",
        punctuation: "#111827",
        link: "#2563eb",
        number: "#7c3aed",
        property: "#06b6d4",
        highlight: "rgba(241,245,249,0.60)",
        highlightHover: "rgba(241,245,249,0.35)",
      ...
      dark: convertToShikiTheme({
        ...
        parameter: "#fbbf24",
        function: "#fb7185",
        stringExpression: "#22d3ee",
        punctuation: "#f5f5f5",
        link: "#93c5fd",
        number: "#c4b5fd",
        property: "#67e8f9",
        highlight: "rgba(31,41,55,0.60)",
        highlightHover: "rgba(31,41,55,0.35)",
  ...
  ember: {
    ...
    syntax: {
      light: convertToShikiTheme({
        ...
        number: "#fb923c",
        property: "#ef4444",
        highlight: "rgba(239,68,68,0.10)",
        highlightHover: "rgba(239,68,68,0.06)",
      ...
      dark: convertToShikiTheme({
        ...
        parameter: "#f59e0b",
        function: "#fda4af",
        stringExpression: "#fbbf24",
        punctuation: "#f3f4f6",
        link: "#fca5a5",
        number: "#fde68a",
        property: "#fca5a5",
        highlight: "rgba(248,113,113,0.18)",
        highlightHover: "rgba(248,113,113,0.10)",
  ...
  pastel: {
    ...
    syntax: {
      light: convertToShikiTheme({
        ...
        highlightHover: "rgba(167,139,250,0.08)",
        highlightBorder: "#c4b5fd",
        diffInserted: "#34d399",
        diffDeleted: "#f87171",
      }),
      dark: convertToShikiTheme({
        ...
        parameter: "#fde68a",
        function: "#c4b5fd",
        stringExpression: "#f9a8d4",
        punctuation: "#e5e7eb",
        link: "#93c5fd",
        number: "#fde68a",
        property: "#86efac",
        highlight: "rgba(196,181,253,0.18)",
        highlightHover: "rgba(196,181,253,0.10)",
        highlightBorder: "#c4b5fd",
        diffInserted: "#86efac",
        diffDeleted: "#fca5a5",
  ...
  solar: {
    ...
    syntax: {
      light: convertToShikiTheme({
        ...
        highlightHover: "rgba(249,115,22,0.06)",
      ...
      dark: convertToShikiTheme({
        ...
        parameter: "#fca5a5",
        function: "#f59e0b",
        stringExpression: "#fdba74",
        punctuation: "#f3f4f6",
        link: "#fca5a5",
        number: "#fde68a",
        property: "#f59e0b",
        highlight: "rgba(251,146,60,0.20)",
        highlightHover: "rgba(251,146,60,0.12)",
  ...
  neon: {
    ...
    syntax: {
      light: convertToShikiTheme({
        ...
        parameter: "#a78bfa",
        function: "#06b6d4",
        stringExpression: "#22c55e",
        punctuation: "#0b1324",
        link: "#06b6d4",
        number: "#f59e0b",
        property: "#22d3ee",
        highlight: "rgba(14,165,233,0.14)",
        highlightHover: "rgba(14,165,233,0.08)",
      ...
      dark: convertToShikiTheme({
        ...
        number: "#fde68a",
        property: "#67e8f9",
        highlight: "rgba(34,211,238,0.22)",
        highlightHover: "rgba(34,211,238,0.12)",
        highlightBorder: "#22d3ee",
        diffInserted: "#86efac",
        diffDeleted: "#fca5a5",
      }),
